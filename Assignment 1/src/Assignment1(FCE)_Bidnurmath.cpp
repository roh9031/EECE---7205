...
int main(){
    ...
    cin.ignore(numeric_limits<streamsize>::max(), '\n');
     ...
     switch (choice){
         ...
         default: cout<<"invalid choice enter 1 to 12\n"; break;
  ...
  heap sort 
  quick sort and bubble are included but unused.(commented out)*/ 
/*
...
/* quick sort function written but not used
...
void problem4solution(){
    ...
    one more approach is creating a fixed array called count with 26 letters pre filled with 0 looping thorugh 
    each string and getting their counts and setting the counts array as the key and pushing it into the 
